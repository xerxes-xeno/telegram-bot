    ...
    "charmeleon": {
        ...
        "stats": {
            ...
            "speed": {
                ...
                "file_id": "AgACAgUAAxkBAAIDp2qaXzr3BD51OtUIwN2y1Pb0oKzeAALvEWsbEovQVBkf4868fi6FAQADAgADeQADPQQ",
...
def build_info_text(data):
    ...
    return (
        ...
        f"┃\n"
        f"┃ ┌─ 𝐁𝐀𝐒𝐄 𝐒𝐓𝐀𝐓𝐒 ─┐\n"
        f"┃ │ HP  : {stats['hp']['base']}           {stats['hp']['range']}\n"
        f"┃ │       {stats['hp']['bar']}\n"
        f"┃ │ Atk : {stats['attack']['base']}       {stats['attack']['range']}\n"
        f"┃ │       {stats['attack']['bar']}\n"
        f"┃ │ Def : {stats['defense']['base']}      {stats['defense']['range']}\n"
        f"┃ │       {stats['defense']['bar']}\n"
        f"┃ │ SpA : {stats['sp_attack']['base']}    {stats['sp_attack']['range']}\n"
        f"┃ │       {stats['sp_attack']['bar']}\n"
        f"┃ │ SpD : {stats['sp_defense']['base']}   {stats['sp_defense']['range']}\n"
        f"┃ │       {stats['sp_defense']['bar']}\n"
        f"┃ │ Spe : {stats['speed']['base']}        {stats['speed']['range']}\n"
        f"┃ │       {stats['speed']['bar']}\n"
        f"┃ └────────────────┘\n"
        f"┃\n"
        f"╰━━━━━━━━━━━━━━━━━╯"
